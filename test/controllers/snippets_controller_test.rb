...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { private: @snippet.private, slug: @snippet.slug, snippet_text: @snippet.snippet_text }
    end
  ...
  test "should update snippet" do
    patch :update, id: @snippet, snippet: { private: @snippet.private, slug: @snippet.slug, snippet_text: @snippet.snippet_text }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
